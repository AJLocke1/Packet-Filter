from Frames.custom_components import Container, Custom_Frame, Scrolable_Container, Sidebar
...
class Info_Frame(Custom_Frame):
    ...
    def initialise_containers(self, App):
        ...
        self.sidebar_container = Sidebar(self, App, padx=App.uniform_padding_x, pady=App.uniform_padding_y, title="Options", subcontainers=self.subcontainers, loadedcontainer=self.information_container)

    def populate_containers(self, App):
        self.label = ctk.CTkLabel(self.log_container, text="Information")
