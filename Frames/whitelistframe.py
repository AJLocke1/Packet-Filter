...
class Whitelist_Frame(Custom_Frame):
    ...
    def initialise_containers(self, App):
        ...
        self.mac_address_whitelist_container = Whitelist_Container(self.main_container, App, name ="MAC Address", description="whitelist and blacklist different MAC addresses", pady=App.uniform_padding_y)
