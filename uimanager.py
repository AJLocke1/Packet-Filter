from UI.Frames import exceptionframe, settingsframe, utilitiesframe, whitelistframe, loginframe, helpframe
class UI_Manager():
    """
    Responsible for managing the Applications UI components. 
    """
    ...
    def initiate_frames(self):
        ...
        return [App.login_frame, App.whitelist_frame, App.rule_frame, App.settings_frame, App.utilities_frame, App.help_frame]
